...
double tiempoLluvia=0, tiempoAnteLluvia=0;
float intervaloLluvia=0,VelocidadLluviaAnte=0;
...
//float Voltajes[] = {106,77,215,145,337,286,741,705,1023,971,1023,826,923,483,546,98};//198
float Voltajes[] = {68,48,138,94,215,183,473,450,709,621,665,528,590,305,346,62};//129
...
///////////////////////////////////////////////////////////////
 ...
 ///////////////////////////////////////////////////////////////////
  ...
  if(ContadorLluvia>=2){  VelocidadLluvia=0; 
                        ContadorLluvia=0;
                         }
...
if((contador1<1 && tiempoReset>=TiempoLectura)){
  ...
  VelocidadAnemo=(float(ContadorVueltas/10.0))*2.4;
...
///////////////////////////////////
 ...
 /* Serial.print(int(hum));
  ...
  Serial.print(",");
  //*///Serial.print(int(VelocidadAnemo*1000));
  //Serial.print(",");
