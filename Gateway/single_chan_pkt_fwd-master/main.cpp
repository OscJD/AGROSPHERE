...
void createFile(int iden )
{
   ...
   archivo.close();	
   if(iden==1){
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos1.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message <<","<<rssi <<endl;  
   archivo.close();
   }
  else if(iden==2){
	   
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos2.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message <<","<<rssi<< endl; 
   archivo.close();
   }
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos3.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos4.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos5.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos6.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos7.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos8.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos9.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
   archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos10.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
    archivo.close();
   ...
   archivo.open("/home/pi/Desktop/single_chan_pkt_fwd-master/datos15.txt",ios::app);
   archivo << 1900+ltm->tm_year <<"," << 1 + ltm->tm_mon <<"," <<ltm->tm_mday <<"," <<ltm->tm_hour <<":" << ltm->tm_min <<":"<<ltm->tm_sec << " Mensaje: " << message<<","<<rssi << endl; 
    archivo.close();
   ...
   if(digitalRead(dio0Pin) == 1)
   {
	    ...
	    rssi=-1*(readRegister(0x1A)-rssicorr);
		   ...
		   if(k==1){
			...
			///////////IDENTIFICAR HUMEDAD
            int m=k+1;
			while(message[m] != ',' &&  m<=(int)receivedbytes ) {
				m++;
				}
				//printf("M= %d :\n", m);
		   if((m-k)==2){
			...
			printf("HUMEDAD TRANSMISOR :\n");
            printf("%d ",HUMITY);
            printf("\n");
            
            ///////////IDENTIFICAR ALTITUDE
            int n=m+1;
			while(message[n] != ',' &&  n<=(int)receivedbytes ) {
				n++;
				}
				//printf("M= %d :\n", m);
		   if((n-m)==2){
			   ...
			   char d=message[m+4];
				...
				int ID3= (c -'0')*10;
				int ID4= (d -'0');
				ALTITUDE=ID1+ID2+ID3+ID4;
			   }	      
			   
			printf("ALTITUDE TRANSMISOR :\n");
            printf("%d ",ALTITUDE);
            printf("\n");
			////////////ESCRIBIR ARCHIVO
